...
const About = () => {
  return (
    <Section index={1} sectionTitle="박지원 Jiwon Park" sectionSubTitle="Junior frontend developer">
      <Contact index={2} />
      <div className="animate-in flex flex-col gap-6" style={{ "--index": 5 } as React.CSSProperties}>
        <ul>
        ...
        <p>
          평소의 저는 게임과 이스포츠 시청을 좋아합니다. 책을 읽으려고 노력하고, 수영을 시작한 지 얼마 되지 않아 즐겁게 배우고 있습니다. 🏊💦
        </p>
        ...
        <p className="italic">아래 제 플레이리스트 같이 들어요 ♪</p>
      </div>
      <Playlist index={6} />
    </Section>
  )
